...
#endif
{
	public interface IDbObservable
	{
		...
		IObservable<IInsertingEntry   <Object, DbContext, TService>> FromInserting<TService>();
		IObservable<IInsertingEntry   <Object, DbContext, TService>> FromInserting<TService>(IScheduler scheduler);
		...
		IObservable<IInsertFailedEntry<Object, DbContext, TService>> FromInsertFailed<TService>();
		IObservable<IInsertFailedEntry<Object, DbContext, TService>> FromInsertFailed<TService>(IScheduler scheduler);
		...
		IObservable<IInsertedEntry    <Object, DbContext, TService>> FromInserted<TService>();
		IObservable<IInsertedEntry    <Object, DbContext, TService>> FromInserted<TService>(IScheduler scheduler);
		...
		IObservable<IDeletingEntry    <Object, DbContext, TService>> FromDeleting<TService>();
		IObservable<IDeletingEntry    <Object, DbContext, TService>> FromDeleting<TService>(IScheduler scheduler);
		...
		IObservable<IDeleteFailedEntry<Object, DbContext, TService>> FromDeleteFailed<TService>();
		IObservable<IDeleteFailedEntry<Object, DbContext, TService>> FromDeleteFailed<TService>(IScheduler scheduler);
		...
		IObservable<IDeletedEntry     <Object, DbContext, TService>> FromDeleted<TService>();
		IObservable<IDeletedEntry     <Object, DbContext, TService>> FromDeleted<TService>(IScheduler scheduler);
		...
		IObservable<IUpdatingEntry    <Object, DbContext, TService>> FromUpdating<TService>();
		IObservable<IUpdatingEntry    <Object, DbContext, TService>> FromUpdating<TService>(IScheduler scheduler);
		...
		IObservable<IUpdateFailedEntry<Object, DbContext, TService>> FromUpdateFailed<TService>();
		IObservable<IUpdateFailedEntry<Object, DbContext, TService>> FromUpdateFailed<TService>(IScheduler scheduler);
		...
		IObservable<IUpdatedEntry     <Object, DbContext, TService>> FromUpdated<TService>();
		IObservable<IUpdatedEntry     <Object, DbContext, TService>> FromUpdated<TService>(IScheduler scheduler);
	...
	where TDbContext : DbContext
	{
		...
		IObservable<IInsertingEntry   <TEntity, TDbContext, TService>> FromInserting<TService>();
		IObservable<IInsertingEntry   <TEntity, TDbContext, TService>> FromInserting<TService>(IScheduler scheduler);
		...
		IObservable<IInsertFailedEntry<TEntity, TDbContext, TService>> FromInsertFailed<TService>();
		IObservable<IInsertFailedEntry<TEntity, TDbContext, TService>> FromInsertFailed<TService>(IScheduler scheduler);
		...
		IObservable<IInsertedEntry    <TEntity, TDbContext, TService>> FromInserted<TService>();
		IObservable<IInsertedEntry    <TEntity, TDbContext, TService>> FromInserted<TService>(IScheduler scheduler);
		...
		IObservable<IDeletingEntry    <TEntity, TDbContext, TService>> FromDeleting<TService>();
		IObservable<IDeletingEntry    <TEntity, TDbContext, TService>> FromDeleting<TService>(IScheduler scheduler);
		...
		IObservable<IDeleteFailedEntry<TEntity, TDbContext, TService>> FromDeleteFailed<TService>();
		IObservable<IDeleteFailedEntry<TEntity, TDbContext, TService>> FromDeleteFailed<TService>(IScheduler scheduler);
		...
		IObservable<IDeletedEntry     <TEntity, TDbContext, TService>> FromDeleted<TService>();
		IObservable<IDeletedEntry     <TEntity, TDbContext, TService>> FromDeleted<TService>(IScheduler scheduler);
		...
		IObservable<IUpdatingEntry    <TEntity, TDbContext, TService>> FromUpdating<TService>();
		IObservable<IUpdatingEntry    <TEntity, TDbContext, TService>> FromUpdating<TService>(IScheduler scheduler);
		...
		IObservable<IUpdateFailedEntry<TEntity, TDbContext, TService>> FromUpdateFailed<TService>();
		IObservable<IUpdateFailedEntry<TEntity, TDbContext, TService>> FromUpdateFailed<TService>(IScheduler scheduler);
		...
		IObservable<IUpdatedEntry     <TEntity, TDbContext, TService>> FromUpdated<TService>();
		IObservable<IUpdatedEntry     <TEntity, TDbContext, TService>> FromUpdated<TService>(IScheduler scheduler);
